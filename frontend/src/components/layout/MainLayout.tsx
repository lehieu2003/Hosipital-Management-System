        ...
        <div className='flex h-full flex-col'>
          ...
          >
            <nav
              ...
              className={cn(
                isSidebarOpen ? 'space-y-6' : 'space-y-4 lg:space-y-6',
              )}
                      ...
                      {visibleItems.map((item) => {
                        ...
                        return (
                          <NavLink
                            ...
                            className={({ isActive }) =>
                              cn(
                                ...
                                !isSidebarOpen &&
                                  'justify-center gap-0 px-0 lg:justify-center lg:px-0',
                              )
                            }
                            onClick={closeSidebarOnMobile}
                          ...
                          >
                            ...
                            <span
                              className={cn(
                                !isSidebarOpen && 'sr-only lg:sr-only',
                              )}
                            >
                              {item.label}
                            </span>
          ...
          <div
            className={cn(
              'border-t border-white/60 p-4',
              !isSidebarOpen && 'p-3 lg:p-4',
            )}
          >
            <div
              className={cn(
                'rounded-3xl bg-white/72 p-4 shadow-sm ring-1 ring-slate-200/70',
                !isSidebarOpen && 'p-2.5 lg:p-4',
              )}
            >
              <div
                className={cn(
              ...
              >
                ...
                <Button
                  aria-label='Sign out'
                  className={cn(
                    'size-9 rounded-xl text-slate-500 hover:text-slate-900',
                    !isSidebarOpen && 'hidden lg:hidden',
                  )}
                  onClick={() => void logout()}
                  size='icon'
          ...
          <div className='flex h-[74px] items-center gap-4 px-4 sm:px-5 lg:px-8'>
            ...
            <div className='ml-auto flex items-center gap-2 sm:gap-3'>
              ...
              <Button
                ...
                className='relative size-10 rounded-xl text-slate-500 hover:text-slate-900'
                size='icon'
                variant='ghost'
              >
        ...
        <main className='px-4 py-5 sm:px-5 lg:px-8 lg:py-7'>
          <div className='mb-6 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between'>
            <div className='space-y-3'>
              ...
              <div className='space-y-2'>
                ...
                <p className='max-w-2xl text-sm leading-6 text-slate-500'>
                  Role-aware operational surfaces with fail-closed behavior and
                  stable diagnostics.
                </p>
              </div>
            </div>
            <div className='flex flex-col gap-3 sm:flex-row'>
              <Button
                className='h-11 justify-start rounded-2xl border-white/80 bg-white/90 text-slate-700 shadow-sm'
                variant='outline'
              >
