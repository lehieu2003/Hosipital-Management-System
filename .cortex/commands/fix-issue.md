...
## Usage
Use this command guide for a reported bug, regression, or failing path.
...
- Ensure code follows `.cortex/rules/code-style.md`
- Handle errors per `.cortex/rules/error-handling.md`
...
### 6. Commit
Follow `.cortex/rules/git-workflow.md`:
```
